// this is the file associated with 'ding_machine' library
//   - package name from cargo.toml
//   - it will be an actualy system library, a static one
//
// by default, all functions are private, must be made public with 'pub'
