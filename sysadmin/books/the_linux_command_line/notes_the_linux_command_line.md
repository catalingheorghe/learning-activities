...
0. [About](#0-about)
1. [Shell notes and Linux intro](#1-shell-notes-and-linux-intro)
	- [Basic](#basic)
	...
	- [Processes](#processes)
2. [Configuration and the Environment](#2-configuration-and-the-environment)
...
The **environment is established** by reading a series of configuration scripts, *startup files*. First, default env for all users, followed by startup files in the user's home directory. The exact sequence depends on the type of shell session.
...
When terminals were hooked to remote computers, there were different brands and types of terminals. Unix-like systems have two complex subsystems to handle the complexities of terminal color: termcap and terminfo. ANSI developed a standard set ot character sequences to control video terminals.
